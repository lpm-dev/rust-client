...
import { sealReleaseCandidate } from "./release-candidate.mjs";

const options = parseArguments(process.argv.slice(2));
sealReleaseCandidate({
  githubReleaseDirectory: required(options, "github-release"),
  npmPackagesDirectory: required(options, "npm-packages"),
