...
| THR-004 | Historical review and CI | Correctness | Scan limits | Head-and-tail sampling omits the upload implementation in the 3.7 MB tinycolor bundle. | Verified | `source_in_the_middle_of_a_four_megabyte_bundle_is_analyzed`; `audit_sampled_source_reports_incomplete_coverage_even_without_findings` | `f44b769b`, `86103278` | Included in this PR |
