...
fn classify_interface(name: &str, ip: &std::net::IpAddr) -> InterfaceType {
    ...
    // Docker interfaces
    if name_lower.starts_with("docker") || name_lower.starts_with("br-") || name_lower == "docker0"
    {
...
mod tests {
    ...
    fn docker_ip_range_only_172_17() {
        ...
        assert_eq!(
            classify_interface("unknown0", &docker_ip),
        ...
        assert_ne!(
            classify_interface("unknown0", &vpc_ip),
            InterfaceType::Docker
        );
        ...
        assert_ne!(
            classify_interface("unknown0", &vpn_ip),
            InterfaceType::Docker
        );
    }
