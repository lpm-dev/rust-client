...
fn collect_tags_from_analysis(
	...
	// Source tags
	if s.filesystem { counts.entry("filesystem").or_default().push(pkg_id.to_string()); }
	if s.network { counts.entry("network").or_default().push(pkg_id.to_string()); }
	if s.child_process { counts.entry("child_process").or_default().push(pkg_id.to_string()); }
	if s.environment_vars { counts.entry("environment_vars").or_default().push(pkg_id.to_string()); }
	if s.eval { counts.entry("eval").or_default().push(pkg_id.to_string()); }
	if s.native_bindings { counts.entry("native_bindings").or_default().push(pkg_id.to_string()); }
	if s.crypto { counts.entry("crypto").or_default().push(pkg_id.to_string()); }
	if s.shell { counts.entry("shell").or_default().push(pkg_id.to_string()); }
	if s.web_socket { counts.entry("web_socket").or_default().push(pkg_id.to_string()); }
	if s.dynamic_require { counts.entry("dynamic_require").or_default().push(pkg_id.to_string()); }

	// Supply chain tags
	if sc.obfuscated { counts.entry("obfuscated").or_default().push(pkg_id.to_string()); }
	if sc.high_entropy_strings { counts.entry("high_entropy").or_default().push(pkg_id.to_string()); }
	if sc.minified { counts.entry("minified").or_default().push(pkg_id.to_string()); }
	if sc.telemetry { counts.entry("telemetry").or_default().push(pkg_id.to_string()); }
	if sc.url_strings { counts.entry("url_strings").or_default().push(pkg_id.to_string()); }
	if sc.trivial { counts.entry("trivial").or_default().push(pkg_id.to_string()); }
	if sc.protestware { counts.entry("protestware").or_default().push(pkg_id.to_string()); }

	// Manifest tags
	if m.git_dependency { counts.entry("git_dependency").or_default().push(pkg_id.to_string()); }
	if m.http_dependency { counts.entry("http_dependency").or_default().push(pkg_id.to_string()); }
	if m.wildcard_dependency { counts.entry("wildcard_dependency").or_default().push(pkg_id.to_string()); }
	if m.copyleft_license { counts.entry("copyleft_license").or_default().push(pkg_id.to_string()); }
	if m.no_license { counts.entry("no_license").or_default().push(pkg_id.to_string()); }
}
