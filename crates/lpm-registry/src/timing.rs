...
struct MetadataFetchDetailCounters {
    ...
    route_npm_direct_selected_history_count: AtomicU64,
...
impl MetadataFetchDetailCounters {
    fn reset(&self) {
        ...
        self.route_npm_direct_selected_history_count
    ...
    fn record(&self, record: MetadataFetchDetailRecord) {
        ...
        match record.route {
            ...
            "npm_direct_selected_history" => &self.route_npm_direct_selected_history_count,
    ...
    fn snapshot(&self) -> MetadataFetchDetailSnapshot {
        MetadataFetchDetailSnapshot {
            ...
            route_npm_direct_selected_history_count: self
                .route_npm_direct_selected_history_count
...
pub struct MetadataFetchDetailSnapshot {
    ...
    pub route_npm_direct_selected_history_count: u64,
